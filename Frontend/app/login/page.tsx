    ...
    return (
        <div className="min-h-screen bg-black flex flex-col lg:flex-row overflow-hidden selection:bg-cyan-500/30">
            ...
            <motion.div
                ...
                className="absolute top-[20%] right-[15%] w-32 h-32 border border-cyan-500/20 rotate-45"
            />
            <motion.div
                animate={{ y: [0, 30, 0], rotate: [0, -360] }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="absolute bottom-[30%] right-[20%] w-24 h-24 border border-indigo-500/20 rounded-full"
            />
            <motion.div
                animate={{ y: [0, -15, 0], x: [0, 10, 0] }}
                transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
                className="absolute top-[40%] left-[5%] w-16 h-16 border-l-2 border-t-2 border-cyan-400/30"
            />
            
            {/* Diagonal Lines */}
            <svg className="absolute inset-0 w-full h-full z-0 opacity-10 pointer-events-none">
                <line x1="0" y1="0" x2="100%" y2="100%" stroke="url(#lineGrad1)" strokeWidth="1" />
                <line x1="100%" y1="0" x2="0" y2="100%" stroke="url(#lineGrad2)" strokeWidth="1" />
                <defs>
                ...
                <div className="relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-400 font-light max-w-md leading-relaxed">
                            Enter the gateway to institutional-grade wealth management and real-time AI intelligence.
                        </p>
                    </motion.div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 lg:p-16 relative">
                ...
                <motion.div
                    ...
                    className="absolute top-[8%] left-[3%] w-36 p-3 rounded-xl bg-gradient-to-br from-cyan-900/40 to-blue-900/40 border border-cyan-500/20 backdrop-blur-md shadow-xl z-0"
                >
                    <div className="flex items-center gap-2 mb-2">
                        <TrendingUp className="w-4 h-4 text-cyan-400" />
                        <span className="text-xs font-medium text-white">Portfolio</span>
                    </div>
                    <div className="text-lg font-bold text-white">$124.5K</div>
                ...
                <motion.div
                    ...
                    className="absolute top-[5%] right-[5%] w-36 p-3 rounded-xl bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border border-indigo-500/20 backdrop-blur-md shadow-xl z-0"
                >
                    <div className="flex items-center gap-2 mb-2">
                        <div className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse" />
                        <span className="text-xs font-medium text-white">AI Insight</span>
                    </div>
                    <p className="text-[10px] text-slate-300">Bullish trend detected</p>
                </motion.div>

                <motion.div
                    animate={{ y: [0, -10, 0], x: [0, 5, 0] }}
                    transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 2 }}
                    className="absolute bottom-[8%] right-[3%] w-32 p-3 rounded-xl bg-gradient-to-br from-emerald-900/30 to-cyan-900/30 border border-emerald-500/20 backdrop-blur-md shadow-xl z-0"
                >
                    <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-medium text-white">BTC</span>
                        <span className="text-emerald-400 text-xs">+5.2%</span>
                    </div>
                    <div className="text-lg font-bold text-white">$67,432</div>
                </motion.div>
                ...
                >
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/30 to-blue-500/30 rounded-2xl blur-xl" />
                    
                    {/* Card Content */}
                    <div className="relative bg-white/5 border border-white/10 ring-1 ring-white/20 backdrop-blur-xl rounded-2xl p-8 shadow-2xl hover:shadow-cyan-500/20 hover:ring-cyan-500/30 transition-all duration-300">
                    <div className="mb-12">
