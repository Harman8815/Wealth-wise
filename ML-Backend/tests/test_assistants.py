...
def test_answer_goal_question(mock_get_goals, mock_get_profile, mock_generate):
    ...
    mock_get_profile.return_value = {"data": {"name": "John", "monthly_income": 50000}}
...
def test_answer_budget_question(mock_get_transactions, mock_get_budget, mock_get_profile, mock_generate):
    mock_get_transactions.return_value = {"data": {"results": [
        {"date": "2026-08-25", "type": "income", "amount": 50000},
        {"date": "2026-08-25", "type": "expense", "amount": 30000},
    ]}}
